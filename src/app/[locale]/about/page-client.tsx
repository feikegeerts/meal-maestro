                              ...
                              <PopoverContent className="w-80">
                                <div className="space-y-2">
                                  <p className="text-sm font-medium">
                                    {t(
                                      "costs.infrastructure.vercelLimits.title",
                                    )}
                                  </p>
                            ...
                            <Popover>
                              ...
                              <PopoverContent className="w-80">
                                <div className="space-y-2">
                                  <p className="text-sm font-medium">
                                    {t(
                                      "costs.infrastructure.neonLimits.title",
                                    )}
                                  </p>
                                  <ul className="text-xs space-y-1 text-muted-foreground">
                                    <li>
                                      •{" "}
                                      {t(
                                        "costs.infrastructure.neonLimits.bandwidth",
                                      )}
                                    </li>
                                    <li>
                                      •{" "}
                                      {t(
                                        "costs.infrastructure.neonLimits.storage",
                                      )}
                                    </li>
                                    <li>
                                      •{" "}
                                      {t(
                                        "costs.infrastructure.neonLimits.usage",
                                      )}
                                    </li>
                                    <li>
                                      •{" "}
                                      {t(
                                        "costs.infrastructure.neonLimits.userLimit",
                                      )}
                                    </li>
                                  </ul>
                                </div>

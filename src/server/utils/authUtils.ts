 ...
 * This method compares the first 10 characters of the session token with the verification token
 * NOTE: This is a simplified method for compatibility with existing code.
